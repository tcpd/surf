...
<%
   ...
   if(request.getParameter("state") != null){
	...
	//use overloaded method getIncumbents(attribute, value)to filter
...
/*var paramNameDropDown = document.getElementById("filterParam");
for(var i = 0; i<filterParams.length; i++){
    var optF = filterParams[i];
    var elF = document.createElement("option");
    elF.textContent = optF;
    elF.value = optF;
    paramNameDropDown.appendChild(elF);
